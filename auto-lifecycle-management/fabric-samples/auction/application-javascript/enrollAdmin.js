...
async function connectToOrg1CA() {
    ...
    const caOrg1Client = buildCAClient(FabricCAServices, ccpOrg1, 'ca.manufacturer.automobile-lifecycle.com');

    const walletPathOrg1 = path.join(__dirname, 'wallet/manufacturer');
...
async function connectToOrg2CA() {
    ...
    const caOrg2Client = buildCAClient(FabricCAServices, ccpOrg2, 'ca.dealer.automobile-lifecycle.com');

    const walletPathOrg2 = path.join(__dirname, 'wallet/dealer');
